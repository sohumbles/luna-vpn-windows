...
[assembly: AssemblyInformationalVersion("1.5.1-release")]

internal static class LunaInstaller
{
    private const string Version = "1.5.1-release";
    ...
    private sealed class InstallerForm : Form
    {
        ...
        private async Task InstallAsync()
        {
            ...
            try
            {
                ...
                MessageBox.Show(
                    "Установка Luna 1.5.1-release завершена.",
                    "Luna",
                    MessageBoxButtons.OK,
